class AgentMessages:
    ...
    Context handling: Input messages format: [@username | First_Name]: content; [@username | First_Name] replied to @username2: content    
    Rules: Respond ONLY to the last message. Use previous messages ONLY for context, if you can't answer the last message immediately. Do not reply to earlier messages directly.    
