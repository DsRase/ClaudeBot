...
class TestSplitTextWithEntities:
    """Сценарии деления текста с entities на чанки."""
    ...
    def test_long_text_split_without_entities(self):
    ...
    def test_entity_on_boundary_moves_to_next_chunk(self):
    ...
    def test_entity_bigger_than_chunk_gets_clipped(self):
    ...
    def test_entity_fully_in_first_chunk_preserved(self):
    ...
    def test_emoji_offsets_in_utf16(self):
